       ...
       PLECTURA-ESP.
           ...
           DISPLAY "FECHA" LINE 9 COL 13.
           DISPLAY "|" LINE 9 COL 23.
           DISPLAY "NOMBRE Y DESCRIPCION" LINE 9 COL 34.
           DISPLAY "|" LINE 9 COL 64.
           DISPLAY "LIBRES" LINE 9 COL 65.
       ...
       WAIT-ORDER.
           ...
           ACCEPT ACCEPT-COMPRA-ENTRADAS LINE 24 COL 80 ON EXCEPTION
       ...
       SALDO-SUFICIENTE.
           ...
           DISPLAY "Compra de entradas de espectaculos" LINE 6 COL 22.
           DISPLAY "Vas a comprar    entradas" LINE 8 COL 15.
           DISPLAY USER-NUM-ENTRADAS LINE 8 COL 29.
           DISPLAY "del espectaculo" LINE 9 COL 15.
           DISPLAY ESP-DESCR LINE 9 COL 31.
           DISPLAY "con fecha" LINE 10 COL 15.
           DISPLAY ESP-DIA LINE 10 COL 25.
           DISPLAY "-" LINE 10 COL 27.
           DISPLAY ESP-MES LINE 10 COL 28.
           DISPLAY "-" LINE 10 COL 30.
           DISPLAY ESP-ANO LINE 10 COL 31.
           DISPLAY "a las" LINE 11 COL 15.
           DISPLAY ESP-HOR LINE 11 COL 21.
           DISPLAY ":" LINE 11 COL 23.
           DISPLAY ESP-MIN LINE 11 COL 24.
           DISPLAY "Codigo del espectaculo: " LINE 12 COL 15.
           DISPLAY ESP-NUM LINE 12 COL 39.
       ...
       PANTALLA-RECOGIDA.
           ...
           DISPLAY "Enter - Aceptar" LINE 4 COL 44.

       RECOGER-ENTER.
           ACCEPT PRESSED-KEY LINE 4 COL 44.
           IF ENTER-PRESSED
               EXIT PROGRAM
           ELSE
               GO TO RECOGER-ENTER.
